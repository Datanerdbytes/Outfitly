...
export const AspectRatioIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M21.5 13.6V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5.4" />
    <path d="m14.5 2.5 7 7" />
    <path d="M21.5 2.5v7h-7" />
  </svg>
);
...
export const MagicWandIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg 
      ...
      strokeLinejoin="round"
    >
        <path d="M15 4V2"/><path d="M15 16v-2"/><path d="M14 9h2"/><path d="M20 9h-2"/><path d="m14 15.08-1.76-1.76a2.49 2.49 0 0 0-3.52 0l-1.76 1.76a2.49 2.49 0 0 0 0 3.52l1.76 1.76a2.49 2.49 0 0 0 3.52 0l1.76-1.76a2.49 2.49 0 0 0 0-3.52Z"/><path d="m9 4-.88.88a2.49 2.49 0 0 0 0 3.52l4.63 4.63a2.49 2.49 0 0 0 3.52 0L17.16 12a2.49 2.49 0 0 0 0-3.52L12.53 3.84a2.49 2.49 0 0 0-3.52 0L8.12 4.72"/>
    </svg>
);
